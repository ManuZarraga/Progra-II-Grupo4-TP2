...
public class Menu {
    ...
    Avion avion1 = new Avion(111, TipoVuelo.NACIONAL, true);
    Avion avion2 = new Avion(222, TipoVuelo.NACIONAL, true);
    Avion avion3 = new Avion(333, TipoVuelo.NACIONAL, true);
    Avion avion4 = new Avion(444, TipoVuelo.INTERNACIONAL, true);
    Avion avion5 = new Avion(555, TipoVuelo.INTERNACIONAL, true);
    Avion avion6 = new Avion(666, TipoVuelo.INTERNACIONAL, true);
    Avion avion7 = new Avion(777, TipoVuelo.INTERNACIONAL, true);
    Avion avion8 = new Avion(888, TipoVuelo.CARGA, true);
    Avion avion9 = new Avion(999, TipoVuelo.CARGA, true);
    Avion avion10 = new Avion(1000, TipoVuelo.CARGA, true);
